  ...
  return (
    <>
      ...
      <div className="relative flex h-screen">
        <aside
          className={`flex flex-col p-8 pl-0 transition-all duration-300 ease-in-out transform w-80 relative ${
            showSidebar ? "ml-0" : "-ml-80"
          }`}
        >
          <div className="ml-8">
          ...
          <p className="ml-8 text-xs font-bold tracking-widest uppercase mt-14 text-grey-dark-quartenary">
            All Boards (2)
          </p>
          ...
          <div className="mt-auto">
            {/* <Button
              ...
              className="mb-4 ml-8 bg-purple-primary"
            >
              Logout
            </Button> */}
            ...
            >
              ...
              <span
                className="text-sm font-medium text-grey-light-tertiary group-hover:text-purple-primary"
          ...
          <Button
            className={`absolute bottom-8 -right-[58px] bg-purple-primary p-3 px-1 rounded-r-full ${
              showSidebar && "hidden"
            }`}
            onClick={sidebarToggle}
          >
