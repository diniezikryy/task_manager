...
const Navbar = ({ showSidebar, board }) => {
  return (
    <nav className="flex flex-row items-center bg-white">
      <div className={`${showSidebar ? "hidden" : "border-r p-6"}`}>
      ...
      <div className="flex flex-row items-center w-full p-6">
        <h1 className={`text-2xl font-bold ${showSidebar ? "" : "ml-6"}`}>
          {board}
        </h1>
