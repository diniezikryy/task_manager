  ...
  return (
    ...
    >
      ...
      <div className="mt-auto">
        <div
          className={`pl-8 flex group items-center mt-auto py-3.5 rounded-r-full hover:bg-grey-light-secondary cursor-pointer`}
        >
          <svg
            width="18"
            height="16"
      ...
      <button
        className={`absolute bottom-8  -right-[56px] bg-purple-primary p-5 rounded-r-full cursor-pointer ${
          showSidebar && "hidden"
        }`}
        onClick={sidebarToggle}
      >
