      ...
      >
        <svg
          ...
          className={`mr-4 group-hover:fill-purple-primary ${
            board === name ? "fill-white" : "fill-grey-light-tertiary"
          }`}
        >
          <path
        ...
        <span
          className={`text-base font-semibold ${
            board === name ? "text-white" : "text-grey-light-tertiary"
